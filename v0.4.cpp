...
void Skaitymas(std::string z, int &y, int &p, int &c, int &b, std::vector<Studentas> &Stud)
{
    std::ifstream fd (z);
    p*=10;
    c=b;
...
int main()
{
    ...
    else
    {
        ...
        std::cout << "Failu kurimas uztruko: "<< diff.count() << " s\n";
...
//        for (int i=c; i<b; i++)
//        {
//            std::ifstream fd1 ("Pirmas.txt");
//            Stud.push_back(Studentas());
//            fd1 >> Stud[i].vardas >> Stud[i].pav >> Stud[i].gal;
//        }
//        p*=10;
//        c=b;
//        b+=p;
//        for (int i=c; i<b; i++)
//        {
//            std::ifstream fd2 ("Antras.txt");
//            Stud.push_back(Studentas());
//            fd2 >> Stud[i].vardas >> Stud[i].pav >> Stud[i].gal;
//        }
//        p*=10;
//        c=b;
//        b+=p;
//        for (int i=c; i<b; i++)
//        {
//            std::ifstream fd3 ("Trecias.txt");
//            Stud.push_back(Studentas());
//            fd3 >> Stud[i].vardas >> Stud[i].pav >> Stud[i].gal;
//        }
//        p*=10;
//        c=b;
//        b+=p;
//        for (int i=c; i<b; i++)
//        {
//            std::ifstream fd4 ("Ketvirtas.txt");
//            Stud.push_back(Studentas());
//            fd4 >> Stud[i].vardas >> Stud[i].pav >> Stud[i].gal;
//        }
//        p*=10;
//        c=b;
//        b+=p;
//        for (int i=c; i<b; i++)
//        {
//            std::ifstream fd5 ("Penktas.txt");
//            Stud.push_back(Studentas());
//            fd5 >> Stud[i].vardas >> Stud[i].pav >> Stud[i].gal;
//        }
        ...
        std::cout << "Surusiuotu studentu isvedimas i du naujus failus uztruko: "<< diff4.count() << " s\n";
    }
